...
public class Modelo_Provincia extends Provincia {
    ...
    public boolean crearProvincia() {
        String sql = "insert into provincia (pro_nombre, pro_region, pro_numcanton, pro_estado) values ('" + getNombre() + "','" + getRegion() + "'," + getNumcanton() + ",'A')";
        return conoc.accion(sql);
    }

    public boolean modificarProvincia() {

        String sql = "UPDATE provincia SET pro_nombre = '" + getNombre() + "', pro_region = '" + getRegion() + "', pro_numcanton = " + getNumcanton() + " WHERE pro_codigo = " + getCodigoPro() + "";
        return conoc.accion(sql);
    }
    ...
    public List<Provincia> listaProvincias() {
        try {
            ...
            while (rs.next()) {
                ...
                pro.setCodigoPro(rs.getInt("pro_codigo"));
                pro.setNombre(rs.getString("pro_nombre"));
                pro.setRegion(rs.getString("pro_region"));
                pro.setNumcanton(rs.getInt("pro_numcanton"));
