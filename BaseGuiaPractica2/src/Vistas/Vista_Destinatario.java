 ...
 * @author HP
 */
public class Vista_Destinatario extends javax.swing.JFrame {

    /**
     * Creates new form Vista_Destinatario
     */
    public Vista_Destinatario() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "DNI", "NOMBRE", "APELLIDO", "EDAD", "TELEFONO", "COD_POSTAL"
            }
        ));
        ...
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/1514134.1.png"))); // NOI18N
        jButton7.setText("DESTINATARIO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vista_Destinatario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vista_Destinatario().setVisible(true);
            }
        });
    }
