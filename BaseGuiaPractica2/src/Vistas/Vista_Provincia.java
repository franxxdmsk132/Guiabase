 ...
 * @author HP
 */
public class Vista_Provincia extends javax.swing.JFrame {

    /**
     * Creates new form Vista_Provincia
     */
    public Vista_Provincia() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CODIGO", "NOMBRE", "REGIÓN", "NUMERO_CANTONES"
            }
        ));
        ...
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/2970119.1.png"))); // NOI18N
        jButton7.setText("PROVINCIAS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vista_Provincia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vista_Provincia().setVisible(true);
            }
        });
    }
