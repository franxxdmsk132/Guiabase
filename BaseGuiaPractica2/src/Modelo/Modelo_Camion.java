...
public class Modelo_Camion extends Camion {
    ...
    public Modelo_Camion(int codigo_camion, String placa, String matricula, String modelo, String Tipo, double potencia, char estado) {
        super(codigo_camion, placa, matricula, modelo, Tipo, potencia, estado);
    }

   

    public boolean crearCamion() {
        String sql = "insert into camion (cmi_placa, cmi_matricula, cmi_modelo, cmi_tipo, cmi_potencia, cmi_est) values ('" + getPlaca() + "','" + getMatricula() + "','" + getModelo() + "','" + getTipo() + "'," + getPotencia() + ",'A')";
    ...
    public boolean eliminarCamion(String placa) {
        ...
        String sqlC = "UPDATE camion SET cmi_est = 'I' WHERE cmi_placa = '" + placa + "'";
    ...
    public List<Camion> listaCamiones() {
        try {
            ...
            String sql = "select * from camion where cmi_est = 'A'";
            ...
            while (rs.next()) {
                ...
                cam.setCodigo_camion(rs.getInt("cmi_codigo"));
    ...
    public List<Camion> listabuscarCamion(String placa) {
        try {
            ...
            String sql = "select * from camion where cmi_est = 'A' and cmi_placa like '" + placa + "%'";
